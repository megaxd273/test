    ...
    <footer id="contacts">
      <div className="footer-container">
        <div className="footer-offer">
          <p>
            The DUMPEST Trucks so far isn't just about the process of building.
            There's a fascinating story to be told there.
          </p>
        ...
        <div className="footer-contacts">
          ...
          <div className="contacts">
            <div className="link-item">
              <a href="https://www.google.com/maps" className="link-line">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="20"
                  height="20"
                ...
                <address className="link-content">
                  3123 center Rd., Minsk
                </address>
              </a>
            </div>
            <div className="link-item">
              <a href="https://web.skype.com/" className="link-line">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="20"
                  height="20"
                ...
                <span className="link-content">+1 (111) 555-0123</span>
              </a>
            </div>
            <div className="link-item">
